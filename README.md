...
|----------|----------|-------------|---------|
| `CONTEMBER_CONTENT_API_URL` | Yes | Contember content API URL | `https://host.contember.cloud/_api/content/project/live` |
...
6. When `X-Session-Id` is provided, conversation history is loaded before and saved after each request, enabling follow-up questions.
